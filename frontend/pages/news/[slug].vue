    ...
    <section id="section-1" class="my-12 py-12 lg:my-14 lg:py-14">
        <div class="container">
            <div class="flex flex-col gap-12 p-8 lg:p-14 bg-[#ECECEE] rounded-[30px]">
                <NuxtLinkLocale :to="'/news'" class="w-max py-2 px-6 text-base text-white bg-primary hover:bg-black rounded-[30px] select-none font-AeonikMedium transition-all duration-300 ease-in-out">{{ t(`General.Button.Back To News`) }}</NuxtLinkLocale>
